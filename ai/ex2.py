...
cur.execute("SELECT code_name, code  FROM possessed_item")
#cur.execute("SELECT code_name, code  FROM realtime_daily_buy_list")
CODE_NAME = []
CODE = []
